...
abstract class BaseOperationExecutorSpec extends Specification {
    ...
    protected static final String TEST_STAGING_PROFILE_ID = "93c08fdebde1ff"
    ...
    protected static final String E2E_TEST_SERVER_BASE_PATH = "https://oss.sonatype.org/service/local/"
}