...
class RepositoryPromoterSpec extends BaseOperationExecutorSpec {
    ...
    private static final String PROMOTE_REPOSITORY_PATH = "service/local/staging/profiles/$TEST_STAGING_PROFILE_ID/promote"
    ...
    def "should promote repository e2e"() {
        given:
            ...
            def closer = new RepositoryPromoter(client, "https://oss.sonatype.org/")
        when:
